...
1. Leggere `PROJECT_CONTEXT.md`, `docs/sdd/01-system-design-document.md`, `.cursor/rules.md` e il task brief.
...
- `templates/` contiene template riutilizzabili.
- `checklists/` contiene controlli di qualità e compliance.
